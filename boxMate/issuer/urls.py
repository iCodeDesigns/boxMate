...
urlpatterns = [
    ...
    path('issuerDB/import' , views.issuer_oracle_DB_import , name = 'list-issuer-db-import'),
    path('issuerDB/cancel' , views.issuer_oracle_DB_cancel , name = 'list-issuer-db-cancel'),
    ...
    path('view/receiver/<int:pk>' , views.view_receiver , name='view-receiver'),
    ...
    path('import/receiver-template', views.import_receiver_template, name='import-receiver-template'),
