...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='invoiceheader',
            name='receiver',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='issuer.Receiver'),
        ),
        ...
        migrations.AlterField(
            model_name='invoiceheader',
            name='document_type',
            field=models.CharField(blank=True, choices=[('i', 'invoice')], default='i', max_length=2, null=True),
        ),
        migrations.AlterField(
            model_name='invoiceheader',
            name='document_type_version',
            field=models.CharField(blank=True, choices=[('1.0', '1.0')], default='1.0', max_length=8, null=True),
        ),
        migrations.AlterField(
            model_name='invoiceheader',
        ...
        migrations.AddField(
            ...
            name='invoice_header',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='taxManagement.InvoiceHeader'),
        ),
        migrations.AddField(
            model_name='invoiceline',
